...
namespace core
{
    namespace misc
    {
         ...
         * current operating system informations, in instaneous method.
         */
...
#else
#define CORE_FIELD_OFFSET(T, x) []() -> glong { return (glong) &(((typename Class<T>::Pointer) null)->x); }
#endif

#endif

#if defined(CORE_COMPILER_MSVC) && !defined(CORE_COMPILER_INTEL)
